...
if (ioutatmpqr==1) then
	...
	write(10,"('END')")
	write(*,*)
	write(*,"(a)") " atmint_tot.pqr, atmint_ele.pqr, atmint_rep.pqr and atmint_disp.pqr have been exported to current folder. &
	Their atomic charge fields record atom contribution to total/electrostatic/repulsive/dispersion interaction energy between all fragments, &
