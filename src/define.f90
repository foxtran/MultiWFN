...
!Translation vector of the cell in Bohr. If any vector has all zero values, that means cell information is not available
real*8 :: cellv1(3)=0,cellv2(3)=0,cellv3(3)=0,cellv1_org(3),cellv2_org(3),cellv3_org(3)
integer :: ifPBC=0 !Dimension of periodic. 0=isolated system, 1/2/3/=one/two/three dimensions
!Other property
